...
#3.1.1
dfDegUP_C1T2 = pd.read_excel("/home/petear/MEGA/TormodGroup/InputData/C_1-T_2_FC_DEGRADERING.xlsx", sheet_name='UP')
dfDegDOWN_C1T2 = pd.read_excel("/home/petear/MEGA/TormodGroup/InputData/C_1-T_2_FC_DEGRADERING.xlsx", sheet_name='DOWN')

dfDegUP_C7T8 = pd.read_excel("/home/petear/MEGA/TormodGroup/InputData/C_7-T_8_FC_DEGRADERING.xlsx", sheet_name='UP')
...
dfDegMergedUP['Versus'] = dfDegMergedUP['Versus'].apply(lambda x: '-'.join(x.split('-')[::-1]))
#Since the logFC values are reversed, what was considered upregulated for Cx-Tx is now downregulated and vice versa:
...
dfDegMergedDOWN['Versus'] = dfDegMergedDOWN['Versus'].apply(lambda x: '-'.join(x.split('-')[::-1]))
#Since the logFC values are reversed, what was considered upregulated for Cx-Tx is now downregulated and vice versa:
